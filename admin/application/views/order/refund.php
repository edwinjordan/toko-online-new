...
<table id="table2" data-toggle="table"
  ...
  <thead>
    <tr>
      ...
      <th data-field="harga" data-align="right">Harga</th>
      <th data-field="jumlah_produk_komplain">Jumlah</th>
      <th data-field="jenis_komplain">Komplain</th>
      <th data-field="id_komplain | jenis_komplain | status_sampai | id_order | nama_produk | id_detail_order | id_penjual  | jumlah_produk_komplain | status_dana_kembali" data-formatter="opsi_refund" data-align="left">
        Opsi
      </th>     
    </tr>
  </thead>
