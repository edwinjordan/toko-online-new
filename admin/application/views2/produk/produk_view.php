...
<script src="<?=base_url('assets/bootstrap-table/dist/bootstrap-table.min.js')?>"></script>
    ...
    <?php echo $this->session->flashdata('item'); ?>
       ...
       data-url="<?php echo site_url('produk/get_produk_data'); ?>"
       data-search="true"
       ...
       >
        ...
        <tr>
            ...
            <th data-field="id_produk" data-sort-order="ASC">ID Produk</th>
            <th data-field="kode_produk">Kode Produk</th>
            <th data-field="nama_produk">Nama Produk</th>
       <!--      <th data-field="kategori_produk">Kategori Produk</th> -->
            <th data-field="harga">Harga</th>
              <th data-field="pajak" data-formatter="pajak" >pajak</th>
            <th data-field="berat">Berat</th>
            <th data-field="deskripsi">Deskripsi</th>
            <th data-field="validasi">Status</th>
            <th data-field="jumlah_stok">Jumlah</th>
            <th   data-field="id_produk | nama_produk" data-formatter="action_produk" data-width="300">Opsi</th>
  ...
  <script type="text/javascript">
      ...
      function action_produk(value, row, index){
        ...
        var hapus="<?=base_url("produk/hapus/")?>/"+row.id_produk;
         ...
         var validasi="<?=base_url("produk/validasi/")?>/"+row.id_produk;
        return '<div class="btn-group" role="group" aria-label="..."> <a href="'+hapus+'" class="btn btn-danger">Hapus</a>  <a href="'+edit+'" class="btn btn-success">Edit</a>  <a href="'+validasi+'" class="btn btn-info">validasi</a> <button onclick="set_modal(\''+row.id_produk+'\',\''+row.nama_produk+'\')" class="btn btn-default" >Setting Pajak</button></div>'
      }
