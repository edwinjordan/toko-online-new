                ...
                <tr>
                  ...
                  <td>
                  		<label class="label <?php 
							if($p['aktif_kategori_produk']==0) echo 'label-danger'; 
							else if($p['aktif_kategori_produk']==1) echo 'label-success'; 
						?>">
												
						<?php 
							if($p['aktif_kategori_produk']==0) echo 'Tidak Aktif';
							else if($p['aktif_kategori_produk']==1) echo 'Aktif';					
						?>
