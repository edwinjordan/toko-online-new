   ...
   <div class="row">
    ...
    <div class="col-md-4">
      <div class="form-group">
        ...
        <input type="email" class="form-control" id="exampleInputEmail1" readonly="" value="<?php echo $info_kontak[0]['provinsi_order']; ?>" style="    background-color: #fff;">
      </div>
    ...
    <div class="col-md-4">
      <div class="form-group">
        ...
        <input type="email" class="form-control" id="exampleInputEmail1" readonly="" value="<?php echo $info_kontak[0]['kota_order']; ?>" style="    background-color: #fff;">
      </div>
    ...
    <div class="col-md-4">
      <div class="form-group">
        ...
        <input type="email" class="form-control" id="exampleInputEmail1" readonly="" value="<?php echo $info_kontak[0]['kode_pos_order']; ?>" style="    background-color: #fff;">
      </div>
    ...
    <div class="col-md-4">
      <div class="form-group">
        ...
        <input type="email" class="form-control" id="exampleInputEmail1" readonly="" value="<?php echo $info_ongkir[0]['jasa_pengiriman']; ?>" style="    background-color: #fff;">
      </div>
     ...
     <div class="col-md-4">
      <div class="form-group">
        ...
        <input type="email" class="form-control" id="exampleInputEmail1" readonly="" value="<?php echo $info_ongkir[0]['ongkir']; ?>" style="    background-color: #fff;">
      </div>

    </div>

    <?php if ($order[0]['no_resi']!="") { ?>
       <div class="col-md-4">
      <div class="form-group">
        <label for="exampleInputEmail1">Nomor Resi</label>
        <input type="email" class="form-control" id="exampleInputEmail1" readonly="" value="<?php echo $order[0]['no_resi']; ?>" style="    background-color: #fff;">
      </div>
