             ...
             <div id="content">
               ...
               <div class="row invoice-info">
                 ...
                 <div class="col-sm-4 invoice-col">
                   ...
                   <address>
                     <?php echo $order[0]['nama_order']; ?>
                     <br><?php echo $order[0]['alamat_order']; ?>
                     <br><?php echo $order[0]['kota_order']; ?> - <?php echo $order[0]['provinsi_order']; ?>, <?php echo $order[0]['kode_pos_order']; ?>
               ...
               <table class="table table-striped">
                 ...
                 <tbody>
                   ...
                   <tr>
                     <td>&nbsp;</th>
                     <td><b>Ongkir<b></td>
                     <td><?php echo $order[0]['ongkir_order']; ?></td>
                   </tr>
                   <tr>
                     <td>&nbsp;</th>
 ...
 <script>
   ...
   doc.save('jeverashop-order-<?php echo $id_order ?>.pdf');
