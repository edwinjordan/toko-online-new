                ...
                <div class="col-md-7 col-sm-7 col-xs-12">
                  <div class="aa-product-view-content">
                    ...
                    <div class="aa-price-block">
                      <span class="aa-product-view-price">Rp.<?php echo $produk_detail[0]['harga'] ?></span>
                      <p class="aa-product-avilability">Avilability: <span><?php echo $produk_detail[0]['stok_produk'] ?></span></p>
                    </div>
