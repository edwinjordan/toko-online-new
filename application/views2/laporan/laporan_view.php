...
<div id="toolbar1" >
<h3>Piutang Untuk Barang/Produk</h3>
</div>

<table data-toggle="table"
       data-url="<?php echo site_url('penjual/laporan/get_piutang'); ?>"
       data-search="true"
       ...
       >
        ...
        <tr>
            ...
            <th data-field="harga_pajak">@Harga pajak</th>
            <th data-field="jumlah_produk">Jumlah</th>
           <th  data-field="subtotal">Sub Total Piutang Sebelum pajak</th>
           <th  data-field="tagihan">Sub Total Piutang Setelah pajak</th>
...
<div id="toolbar2" >
<h3>Piutang Untuk Ongkir</h3>
</div>

<table data-toggle="table"
       data-url="<?php echo site_url('penjual/laporan/get_ongkir_piutang'); ?>"
       data-search="true"
       data-show-refresh="true"
       data-show-toggle="true"
