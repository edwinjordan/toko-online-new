	        	...
	        	<tbody>
	        		<tr>
	          		...
	          		<tr>
	          			...
	          			<td><input type=text name='nama_produk' id="nama" class="form-control" required></td>
	          		</tr>
					...
					<tr>
						...
						<td><input type=text name='berat' id="berat" class="form-control" required></td>
					</tr>
					<tr>
	          		...
	          		<tr>
	          			...
	          			<td><textarea name='deskripsi' id="deskripsi" rows="8" cols="55" class="form-control"> </textarea> </td>
					</tr>
					<tr>
