...
<head>
  ...
  <script type="text/javascript">
      ...
      function action_produk(value, row, index){
        ...
        return '<div class="btn-group" role="group" aria-label="..."> <a href="'+hapus+'" class="btn btn-danger">Hapus</a>  <a href="'+edit+'" class="btn btn-success">Edit</a> <button onclick="set_modal(\''+row.id_produk+'\',\''+row.nama_produk+'\')" class="btn btn-warning" >Setting Pajak</button></div>'
      }
