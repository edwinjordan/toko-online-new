...
<h2>Tambah Jadwal</h2>
          <form method=POST action="<?php echo base_url() . 'penjual/produk/action_add_jadwal' ?>" enctype="multipart/form-data">
          <input type="hidden" name="id_produk" value="<?=$id?>">
          <table class='table table-hover'>
	          <tbody>
	          <tr>
	          	<td class='left'>Tanggal Berangkat</td>      
	          	<td><input type=date name='tgl_berangkat' id="kode" size=60 required></td>
	          </tr>
	          <tr>
	          	<td class='left'>Tanggal Pulang</td>      
	          	<td><input type=date name='tgl_pulang' id="nama" size=60 required></td>
	          </tr>
